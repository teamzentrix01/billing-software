...
const SECTION_PERMISSION_RULES = {
  ...
  Purchase: ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS', 'VIEW_REMOTE_GRN', 'CREATE_REMOTE_GRN', 'APPROVE_REMOTE_GRN'],
...
const ITEM_PERMISSION_RULES = {
  ...
  '/inventory': ['MANAGE_INVENTORY', 'VIEW_INVENTORY'],
  '/purchase': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS', 'VIEW_REMOTE_GRN', 'CREATE_REMOTE_GRN', 'APPROVE_REMOTE_GRN'],
  '/purchase/remote-grn': ['VIEW_REMOTE_GRN', 'CREATE_REMOTE_GRN', 'APPROVE_REMOTE_GRN'],
  '/purchase/vendors': ['MANAGE_VENDORS'],
  '/purchase/purchase-orders': ['MANAGE_PURCHASE_ORDERS'],
  '/purchase/quotations': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS'],
  '/purchase/grn': ['MANAGE_PURCHASE_ORDERS'],
  '/purchase/margin-approvals': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_BILLING', 'MANAGE_CATALOG'],
  '/purchase/returns': ['MANAGE_PURCHASE_ORDERS'],
  '/purchase/vendor-invoices': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS'],
  '/purchase/invoice-settlement': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS'],
  '/purchase/vendor-ledger': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS'],
  '/purchase/vendor-performance': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_VENDORS'],
  '/purchase/auto-reorder': ['MANAGE_PURCHASE_ORDERS', 'MANAGE_INVENTORY'],
  '/sales-order': ['MANAGE_ORDERS', 'VIEW_ORDERS'],
  '/admin/assistant': ['*'],
  '/customer': ['MANAGE_CUSTOMERS', 'VIEW_CUSTOMERS'],
  '/reports': ['VIEW_FINANCIAL_REPORTS', 'VIEW_STORE_REPORTS'],
...
const ROUTE_PERMISSION_RULES = [
  ...
  { prefix: '/purchase/remote-grn', permissions: ['VIEW_REMOTE_GRN', 'CREATE_REMOTE_GRN', 'APPROVE_REMOTE_GRN'] },
