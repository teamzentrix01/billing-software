...
const ITEM_PERMISSION_RULES = {
  ...
  '/sales/store-cash': ['OPEN_CLOSE_SESSION', 'MANAGE_POS', 'MANAGE_BILLING', 'VIEW_STORE_REPORTS'],
...
const ROUTE_PERMISSION_RULES = [
  ...
  { prefix: '/sales/store-cash', permissions: ['OPEN_CLOSE_SESSION', 'MANAGE_POS', 'MANAGE_BILLING', 'VIEW_STORE_REPORTS'] },
